...
class Classifier(object):
    ...
    def __init__(self, encoder_params=None, decoder_params=None):
        ...
        self.trainloader = DataLoader(dataset=coco_train, batch_size=16, shuffle=True, num_workers=2, collate_fn=collate_fn)
        self.testloader = DataLoader(dataset=coco_test, batch_size=16, shuffle=False, num_workers=2, collate_fn=collate_fn)
